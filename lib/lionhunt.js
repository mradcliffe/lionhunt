...
function lionhunt(options) {
    ...
    this.baseUrl = "https://" + options.domain + ".my.workfront.com";
        ...
        issue = {
            ...
            customFieldValues: [
                ...
                },
                {
                    ...
                    value: 'https://' + self.domain + '.my.workfront.com/task/view?ID=' + task.ID
                }
            ],
    ...
    this._formatField = function(map, value) {
        ...
        switch (map.type) {
            ...
            case "com.atlassian.jira.plugin.system.customfieldtypes:datepicker":
                // Hopefully this is generic enough to handle everything. :|
                ret = this._getJiraDate(value);
                break;
    ...
    this._getJiraDate = function(datetime) {
        return datetime.replace(/^(\d+\-\d+\-\d+).*$/, '$1');
    };
